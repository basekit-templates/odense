...
switch(direction) {
 ...
 break;
    ...
    if( e.type === 'mouseenter' ) {
      ...
      element.find("figcaption").removeClass("transform").css(slideFrom);
      element.find("img").addClass("transform").css("transform","matrix(1, 0, 0, 1,"+imgSlide+")");

      setTimeout(function(){
        element.find("figcaption").addClass("transform").css(slideTo);
      },1);
      ...
      element.find("figcaption").addClass("transform").css(slideFrom);
